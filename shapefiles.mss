...
#world-hd-hydropolys::area[zoom>=7][zoom<=11]["Type"!="Ocean"]  {
  ...
  polygon-fill: @water-color;
  [zoom=7]{
    line-color: mix(@land-color, @water-color,50%);
    polygon-fill: mix(@land-color, @water-color,50%);}
  [zoom=8]{
    line-color: mix(@land-color, @water-color,30%);
    polygon-fill: mix(@land-color, @water-color,30%);}
  [zoom=9]{
    line-color: mix(@land-color, @water-color,20%);
    polygon-fill: mix(@land-color, @water-color,20%);}
  [zoom=10]{
    line-color: mix(@land-color, @water-color,10%);
    polygon-fill: mix(@land-color, @water-color,10%);}
}

#world-hd-coast-poly::area [zoom >= 10] {
  polygon-fill: @water-color;
}


#world-nelakes::area [zoom<7]{
  [zoom>=0][ScaleRank=0],
  [zoom>=1][ScaleRank<=1],
  [zoom>=2][ScaleRank<=2],
  [zoom>=3][ScaleRank<=3],
  ...
  [zoom>=6][ScaleRank<=6],{
    ...
    polygon-fill: @water-color;
    [ScaleRank>=1]{
      [zoom=4]{polygon-fill: mix(@land-color, @water-color,70%);}
      [zoom=5]{polygon-fill: mix(@land-color, @water-color,60%);}
      [zoom=6]{polygon-fill: mix(@land-color, @water-color,50%);}
    }
  }
}
...
#world-builtup::area [zoom >= 6][zoom <= 11]{
  [zoom=6]{polygon-fill: darken(@land-color,3%);}
  [zoom=7]{polygon-fill: darken(@land-color,3.5%);}
  [zoom=8]{polygon-fill: darken(@land-color,4%);}
  [zoom=9]{polygon-fill: darken(@land-color,4%);}
  [zoom=10]{polygon-fill: darken(@land-color,4.5%);}
  [zoom=11]{polygon-fill: darken(@land-color,5%);}
}

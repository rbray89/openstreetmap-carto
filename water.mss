...
.water-lines {
  ...
  [waterway = 'wadi'][zoom >= 13] {
    ...
    [bridge = 'yes'] {
      [zoom >= 14] {
        bridgecasing/line-color: @bridge-casing;
    ...
    [waterway = 'wadi'] {
      [bridge = 'yes'][zoom >= 14] {
        bridgefill/line-color: @bridge-fill;
    ...
    [int_tunnel = 'yes'] {
      ...
      tunnelfill/line-color: @tunnelfill-casing;
    ...
    [zoom >= 13] {
      ...
      [bridge = 'yes'] {
        [zoom >= 14] {
          ...
          bridgeglow/line-color: @bridge-low-casing;
